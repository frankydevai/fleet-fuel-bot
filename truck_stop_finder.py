...
Heading filter removed. It caused false "No stop found" alerts when trucks
were on curved ramps where a nearby stop appeared slightly behind the heading.
Distance-only search is simpler and more reliable.
"""
